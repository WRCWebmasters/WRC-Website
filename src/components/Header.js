  ...
  render() {
    return (
      ...
      >
        ...
        <Navbar.Brand href="/">
          <p style={{ fontWeight: "bold", fontSize: 24, marginBottom: 0, color: "#be3019" }}>
            Will Rice College
          </p>
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            <NavDropdown title="ABOUT" id="basic-nav-dropdown">
              <NavDropdown.Item href="/about/will-rice">
                Will Rice
              </NavDropdown.Item>
              <NavDropdown.Item href="/about/traditions">
                Traditions
              </NavDropdown.Item>
            ...
            <NavDropdown title="OPERATING" id="basic-nav-dropdown">
              <NavDropdown.Item href="/operating/budget">
                Budget
              </NavDropdown.Item>
              <NavDropdown.Item href="/operating/constitution">
                Constitution and Bylaws
              </NavDropdown.Item>
              <NavDropdown.Item href="/operating/operating-forms">
                Operating Forms
              </NavDropdown.Item>
              <NavDropdown.Item href="/operating/housing-and-parking ">
                Housing and Parking
              </NavDropdown.Item>
            </NavDropdown>
            ...
            <NavDropdown title="PEOPLE" id="basic-nav-dropdown">
              ...
              <NavDropdown.Item href="/people/alumni-and-associates">
              ...
              <NavDropdown.Item href="/people/fellows">
                Fellows
              </NavDropdown.Item>
              ...
              <NavDropdown.Item href="/people/student-leadership">
                Student Leadership
              </NavDropdown.Item>
            </NavDropdown>
            ...
            <NavDropdown title="RESOURCES" id="basic-nav-dropdown">
              ...
              <NavDropdown.Item href="/resources/calendar">
                Calendar
              </NavDropdown.Item>
              <NavDropdown.Item href="/resources/communications">
                Communications Guidebook
              </NavDropdown.Item>
              <NavDropdown.Item href="/resources/contact">
                Contact
              </NavDropdown.Item>
              <NavDropdown.Item href="/resources/forms-and-finances">
                Forms and Finacnes
              </NavDropdown.Item>
              <NavDropdown.Item href="/resources/off-campus">
                Off Campus
              </NavDropdown.Item>
              <NavDropdown.Item href="/resources/rice-mutual-aid">
                Rice Mutual Aid
              </NavDropdown.Item>
            </NavDropdown>
            ...
            <Nav.Link
              href="https://wrcoweek.wixsite.com/superhero"
              id="rust-text"
              target="_blank"
            >
              NEW STUDENTS
