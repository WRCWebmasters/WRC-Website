          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              <NavDropdown title="GENERAL" id="basic-nav-dropdown">
                ...
                <NavDropdown.Item href="/general/strive">
                  strive
                </NavDropdown.Item>
              ...
              <NavDropdown title="PEOPLE" id="basic-nav-dropdown">
                <NavDropdown.Item href="/people/a-team">
                  a-team
                </NavDropdown.Item>
              ...
              <NavDropdown title="OPERATING" id="basic-nav-dropdown">
                <NavDropdown.Item href="/operating/calendar">
                  calendar
                </NavDropdown.Item>
                {/*should look at this*/}
                <NavDropdown.Item href="/operating/calendardev">
                  calendar dev
                </NavDropdown.Item>
              </NavDropdown>
            </Nav>
